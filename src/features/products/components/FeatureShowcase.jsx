...
function FeatureShowcase() {
  return (
    <Box component="section" sx={{ bgcolor: "#fff", px: { xs: 2, md: 3.5 }, py: { xs: 7, md: 9 } }}>
      <Box sx={{ margin: "0 auto", maxWidth: 830, textAlign: "center" }}>
        <Typography component="h2" sx={{ color: "#111", fontSize: 20, fontWeight: 800, letterSpacing: "-0.6px", mb: 0.6 }}>All the features you need</Typography>
        <Typography sx={{ color: "#888", fontSize: 10 }}>You've got the ideas, we've got the tools</Typography>

        <Box sx={{ display: "grid", gap: 1.5, gridTemplateColumns: { xs: "1fr", sm: "repeat(3, 1fr)" }, mt: 3.2 }}>
          {features.map(({ title, icon: Icon }, index) => (
            <Box key={title} sx={{ bgcolor: "#f7f7f7", borderRadius: "5px", minHeight: 208, overflow: "hidden", p: 1.8, textAlign: "left" }}>
              ...
              <Typography sx={{ color: "#111", fontSize: 11, fontWeight: 700, mb: 0.9 }}>{title}</Typography>
              <Typography sx={{ color: "#888", fontSize: 9, lineHeight: 1.5 }}>Lorem ipsum det, adipiscing elit duis nec fringi det, consec tetur adipiscing elit.</Typography>
            </Box>
          ))}
        </Box>

        <Box sx={{ alignItems: "center", bgcolor: "#f5f5f5", borderRadius: "6px", display: "grid", gap: 2, gridTemplateColumns: { xs: "1fr", md: "1.25fr 1fr" }, mt: 4, overflow: "hidden", textAlign: "left" }}>
          ...
          <Box sx={{ p: { xs: 3, md: 2.8 } }}>
            <Typography sx={{ color: "#111", fontSize: 20, fontWeight: 800, lineHeight: 1.05, mb: 1.25 }}>10,000+ of free images, icons, and graphics</Typography>
            <Typography sx={{ color: "#888", fontSize: 9, mb: 2 }}>You've got the ideas, we've got the tools</Typography>
        ...
        <Box sx={{ minHeight: 220, mt: 5.5, position: "relative" }}>
          ...
          <Box sx={{ left: "50%", position: "absolute", top: "48%", transform: "translate(-50%, -50%)", width: "100%" }}>
            <Typography sx={{ color: "#111", fontSize: 18, fontWeight: 800, lineHeight: 1.12, mb: 0.9 }}>Join the 7,000+<br />companies trusting us</Typography>
            <Typography sx={{ color: "#888", fontSize: 9, mb: 1.6 }}>You've got the ideas, we've got the tools</Typography>
            <Button disableElevation variant="contained" sx={{ bgcolor: "#2cbd7d", borderRadius: "5px", fontSize: 9, minWidth: 78, py: 0.55, textTransform: "none", "&:hover": { bgcolor: "#22a96d" } }}>Get Started</Button>
          </Box>
        </Box>
      </Box>
